...
static const char *fonts[]          = { "Source Code Pro Semibold:Semibold:size=13", "Symbols NF:size=13" };
static const char col_gray1[] = "#2e3440"; // Updated background color
...
static const char *colors[][3] = {
    /*               fg         bg         border   */
    // Normal mode      ice white  New background color  Darker Nord grey
